...
for i=1:2
    ...
    for n1=S
        ...
        PSE_value2(n1,i,1,indi) = coefficients(1);
        PSE_value2(n1,i,2,indi) = coefficients(2);
        PSE_value2(n1,i,3,indi) = PSE_ratio;
        n1
        i
        indi
    end
...
%%
PSE_value2(:,:,3,31) = mean(PSE_value2(:,:,3,1:Indi),4);
PSE_value2(:,:,3,32) = std(PSE_value2(:,:,3,1:Indi),0,4);
